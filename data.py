...
def get_data_loaders(
    ...
    data_transforms = {
        "train": transforms.Compose([transforms.Resize(256),
                                    ...
                                    transforms.RandomAdjustSharpness(85e-2, p=5e-1),
                                    transforms.RandomHorizontalFlip(p=5e-1),
                                    transforms.RandomVerticalFlip(p=5e-1),
                                    transforms.ToTensor(),
                                    transforms.Normalize(mean,std)
                                    ]),
        "valid": transforms.Compose([transforms.Resize(256),
                                    transforms.CenterCrop(224),
                                    transforms.RandomAdjustSharpness(85e-2, p=5e-3),
                                    transforms.RandomHorizontalFlip(p=5e-3),
                                    transforms.RandomVerticalFlip(p=5e-3),
                                    transforms.ToTensor(),
                                    transforms.Normalize(mean,std)
                                    ]),
